...
exports.showExplanationPanel = void 0;
const vscode = __importStar(require("vscode"));
function showExplanationPanel(context, code, explanation) {
    // Create and show panel
    const panel = vscode.window.createWebviewPanel('aiCodeExplanation', '🤖 AI Code Explanation', vscode.ViewColumn.Beside, {
        enableScripts: true,
...
function getWebviewContent(code, explanation) {
